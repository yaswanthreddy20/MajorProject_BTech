...
//        cb.setIncludeRetweetsEnabled(false);
  	  ...
  	  double lat = 55.32443216228089;   // a search with no correct place given will return tweets from India. 
        ...
        try {
            ...
            query.setLang("en");
            query.setGeoCode(new GeoLocation(lat, lon), radius, "km");  // coordinates for India
            QueryResult result;
